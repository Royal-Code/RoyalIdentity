...
Outro ponto é a forma como os EndpointHandler são registrados no IdentityServer4, onde a um mecanismo
...
onde haverão vários handlers que serão executados em sequência e cada um tratará de uma parte
