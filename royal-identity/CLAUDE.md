...
- [.ai/plans/plan-localization.md](.ai/plans/plan-localization.md) — EM EXECUÇÃO; Fases 1-4 concluídas; Fase 5 em andamento. `RealmOptions.Internationalization` é a política realm-scoped de localization (ativa por padrão;
