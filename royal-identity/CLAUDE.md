...
- [.ai/plans/plan-localization.md](.ai/plans/plan-localization.md) — EM EXECUÇÃO; Fases 1, 2 e 4 concluídas; Fases 3 e 5 reabertas após revisão externa. `RealmOptions.Internationalization` é a política realm-scoped de localization (ativa por padrão;
