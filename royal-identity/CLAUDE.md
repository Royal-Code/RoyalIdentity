...
- [.ai/plans/plan-localization.md](.ai/plans/plan-localization.md) — EM EXECUÇÃO; Fase 1 concluída, Fase 2 é a
  próxima. `RealmOptions.Internationalization` é a política realm-scoped de localization (ativa por padrão;
