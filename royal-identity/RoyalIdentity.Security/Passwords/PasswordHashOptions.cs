...
/// The defaults match the legacy hashing parameters (PBKDF2-HMAC-SHA256, 100,000 iterations, 16-byte salt,
/// 32-byte output), so existing hashes are not flagged for rehash solely due to a parameter change.
/// </summary>
