...
[plan-localization.md](plan-localization.md) está em execução: Fases 1-5 concluídas; Fase 6 é a próxima. Ele mantém
...
(EM EXECUÇÃO — 5/7 fases concluídas; Fase 6 é a próxima)
...
7. Executar [plan-localization.md](plan-localization.md) — EM EXECUÇÃO (5/7 concluídas; Fase 6 é a próxima).
